#############################################################################
# Makefile for building: wqq
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  wqq.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile wqq.pro
#############################################################################
...
INCPATH       = -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/declarative_debug.prf \
...
Makefile: wqq.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/lex.prf \
		wqq.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile wqq.pro
...
dist: 
	@test -d .tmp/wqq1.0.0 || mkdir -p .tmp/wqq1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/wqq1.0.0/ && (cd `dirname .tmp/wqq1.0.0` && $(TAR) wqq1.0.0.tar wqq1.0.0 && $(COMPRESS) wqq1.0.0.tar) && $(MOVE) `dirname .tmp/wqq1.0.0`/wqq1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/wqq1.0.0
...
i2c.o: i2c.c i2c.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o i2c.o i2c.c
